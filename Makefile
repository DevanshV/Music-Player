...
C_SRCS += monitor.c
C_SRCS += uart_nios2.c
C_SRCS += drivers/src/altera_avalon_jtag_uart_fd.c
C_SRCS += drivers/src/altera_avalon_jtag_uart_init.c
C_SRCS += drivers/src/altera_avalon_jtag_uart_ioctl.c
C_SRCS += drivers/src/altera_avalon_jtag_uart_read.c
C_SRCS += drivers/src/altera_avalon_jtag_uart_write.c
C_SRCS += drivers/src/altera_avalon_lcd_16207.c
C_SRCS += drivers/src/altera_avalon_lcd_16207_fd.c
C_SRCS += drivers/src/altera_avalon_sysid_qsys.c
C_SRCS += drivers/src/altera_avalon_timer_sc.c
C_SRCS += drivers/src/altera_avalon_timer_ts.c
C_SRCS += drivers/src/altera_avalon_timer_vars.c
C_SRCS += drivers/src/altera_avalon_uart_fd.c
C_SRCS += drivers/src/altera_avalon_uart_init.c
C_SRCS += drivers/src/altera_avalon_uart_ioctl.c
C_SRCS += drivers/src/altera_avalon_uart_read.c
C_SRCS += drivers/src/altera_avalon_uart_write.c
C_SRCS += drivers/src/altera_up_avalon_audio.c
C_SRCS += drivers/src/altera_up_avalon_audio_and_video_config.c
CXX_SRCS :=
ASM_SRCS :=
